...
здесь примеры htmlwidgets

Если `hmtl`-виджет очень понравился, то его можно и в статический документ экспортировать. Виджет, чтобы экспортировать виджеты интерактивно, называется [exportwidget](https://github.com/timelyportfolio/exportwidget). 
